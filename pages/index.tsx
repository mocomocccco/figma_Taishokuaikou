...
import ContactCheckboxes from "../components/contact-checkboxes";
...
const Tablet: NextPage = () => {
  return (
    <div className="w-full relative flex flex-row items-start justify-start leading-[normal] tracking-[normal]">
      <section className="flex-1 bg-white-fff flex flex-col items-start justify-start pt-[20.5px] px-0 pb-0 box-border gap-[39.5px] max-w-full text-left text-lg text-gyar-6a6a6a font-yugothic mq450:gap-[20px]">
            ...
            <div className="flex-1 flex flex-col items-start justify-start gap-[251px] max-w-full ml-[-768px] mq450:gap-[125px]">
              ...
              <div className="self-stretch flex flex-col items-start justify-start max-w-full">
                ...
                <div className="self-stretch h-[67px] flex flex-row flex-wrap items-center justify-center relative max-w-full z-[1] mt-[-0.2px]">
                  ...
                  <ContactCheckboxes prop="電話" prop1="LINE" prop2="メール" />
                </div>
