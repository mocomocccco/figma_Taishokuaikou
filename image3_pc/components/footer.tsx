...
const Footer: NextPage<FooterType> = ({ className = "" }) => {
  return (
    <footer
      className={`self-stretch bg-gyar-6a6a6a overflow-hidden flex flex-col items-center justify-center py-2.5 px-5 gap-[8px] text-left text-xs text-white-fff font-yugothic ${className}`}
    >
